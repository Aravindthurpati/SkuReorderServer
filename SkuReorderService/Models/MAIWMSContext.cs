...
public partial class MAIWMSContext : DbContext
{
    public MAIWMSContext()
    {
    }

    public MAIWMSContext(DbContextOptions<MAIWMSContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<AllStatus> AllStatuses { get; set; }

    public virtual DbSet<Batching> Batchings { get; set; }

    public virtual DbSet<Batchingitem> Batchingitems { get; set; }

    public virtual DbSet<Billingfield> Billingfields { get; set; }
    ...
    public virtual DbSet<Carttote> Carttotes { get; set; }

    public virtual DbSet<Clientcartonsize> Clientcartonsizes { get; set; }

    public virtual DbSet<Clientshipmethod> Clientshipmethods { get; set; }

    public virtual DbSet<Clientstafforderlog> Clientstafforderlogs { get; set; }

    public virtual DbSet<Clientstaffpolog> Clientstaffpologs { get; set; }
    ...
    public virtual DbSet<Cyclecounthistory> Cyclecounthistories { get; set; }

    public virtual DbSet<Cyclecounttracking> Cyclecounttrackings { get; set; }

    public virtual DbSet<Damagereason> Damagereasons { get; set; }

    public virtual DbSet<Defaultmessage> Defaultmessages { get; set; }

    public virtual DbSet<Deliverytrucktype> Deliverytrucktypes { get; set; }

    public virtual DbSet<Errorlog> Errorlogs { get; set; }

    public virtual DbSet<Expiryreason> Expiryreasons { get; set; }

    public virtual DbSet<Fileupload> Fileuploads { get; set; }

    public virtual DbSet<Gridfilter> Gridfilters { get; set; }

    public virtual DbSet<Holidaylist> Holidaylists { get; set; }

    public virtual DbSet<Integrationcarriermapping> Integrationcarriermappings { get; set; }

    public virtual DbSet<Integrationchannel> Integrationchannels { get; set; }

    public virtual DbSet<Integrationdetail> Integrationdetails { get; set; }

    public virtual DbSet<Integrationmapping> Integrationmappings { get; set; }

    public virtual DbSet<Integrationproperty> Integrationproperties { get; set; }

    public virtual DbSet<Integrationtype> Integrationtypes { get; set; }

    public virtual DbSet<Job> Jobs { get; set; }

    public virtual DbSet<Kitlog> Kitlogs { get; set; }

    public virtual DbSet<Localization> Localizations { get; set; }

    public virtual DbSet<Manifest> Manifests { get; set; }

    public virtual DbSet<Manifestcomment> Manifestcomments { get; set; }

    public virtual DbSet<Manifestpackage> Manifestpackages { get; set; }

    public virtual DbSet<Manifestprintdatum> Manifestprintdata { get; set; }

    public virtual DbSet<Manifestskupackagedetail> Manifestskupackagedetails { get; set; }

    public virtual DbSet<Note> Notes { get; set; }

    public virtual DbSet<Order> Orders { get; set; }

    public virtual DbSet<Ordererrorlog> Ordererrorlogs { get; set; }
    ...
    public virtual DbSet<Orderitemstmp> Orderitemstmps { get; set; }

    public virtual DbSet<Orderprocessjob> Orderprocessjobs { get; set; }

    public virtual DbSet<Ordersearchlist> Ordersearchlists { get; set; }

    public virtual DbSet<Ordershipaddresslog> Ordershipaddresslogs { get; set; }

    public virtual DbSet<Ordersjob> Ordersjobs { get; set; }

    public virtual DbSet<Ordersjobitem> Ordersjobitems { get; set; }

    public virtual DbSet<OrderskuSerial> OrderskuSerials { get; set; }

    public virtual DbSet<Ordersshipment> Ordersshipments { get; set; }

    public virtual DbSet<Passwordreset> Passwordresets { get; set; }

    public virtual DbSet<Poissue> Poissues { get; set; }

    public virtual DbSet<Poschedule> Poschedules { get; set; }

    public virtual DbSet<Poupload> Pouploads { get; set; }

    public virtual DbSet<Property> Properties { get; set; }

    public virtual DbSet<Receivingcontainertype> Receivingcontainertypes { get; set; }

    public virtual DbSet<Return> Returns { get; set; }

    public virtual DbSet<Returnitem> Returnitems { get; set; }

    public virtual DbSet<Robilling> Robillings { get; set; }

    public virtual DbSet<Rochargecode> Rochargecodes { get; set; }

    public virtual DbSet<Roreceiving> Roreceivings { get; set; }

    public virtual DbSet<Roreceivingdetail> Roreceivingdetails { get; set; }

    public virtual DbSet<Roreceivinghistory> Roreceivinghistories { get; set; }

    public virtual DbSet<Rotracking> Rotrackings { get; set; }

    public virtual DbSet<Saleschannel> Saleschannels { get; set; }

    public virtual DbSet<Saleschannelmapping> Saleschannelmappings { get; set; }

    public virtual DbSet<Sku> Skus { get; set; }

    public virtual DbSet<Skuautofill> Skuautofills { get; set; }

    public virtual DbSet<Skubarcode> Skubarcodes { get; set; }

    public virtual DbSet<Skuinventorylocation> Skuinventorylocations { get; set; }

    public virtual DbSet<Skuinventorylocationlog> Skuinventorylocationlogs { get; set; }

    public virtual DbSet<Skukitmapping> Skukitmappings { get; set; }

    public virtual DbSet<Skulotcode> Skulotcodes { get; set; }

    public virtual DbSet<Skupackage> Skupackages { get; set; }

    public virtual DbSet<Skushippingbox> Skushippingboxes { get; set; }

    public virtual DbSet<State> States { get; set; }

    public virtual DbSet<VOrdersource> VOrdersources { get; set; }

    public virtual DbSet<ViewOrderShipmentreport> ViewOrderShipmentreports { get; set; }
    ...
    public virtual DbSet<Whmodule> Whmodules { get; set; }

    public virtual DbSet<Whuser> Whusers { get; set; }

    public virtual DbSet<Whuserclient> Whuserclients { get; set; }

    public virtual DbSet<Whusermodule> Whusermodules { get; set; }

    public virtual DbSet<Whuserrefreshtoken> Whuserrefreshtokens { get; set; }

    public virtual DbSet<Whuserwarehouse> Whuserwarehouses { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Server=209.209.40.79;Port=19392;User Id=BOLX2021;Password=bolx@@!!;Database=GLCOCT");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Adjustmentreason>(entity =>
        {
            entity.HasKey(e => e.Reasonid).HasName("pk_adjustmentreason");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("all_status_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("batching_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Batchings)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Shipvia).WithMany(p => p.Batchings)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("batchingitems_pkey");
            ...
            entity.HasOne(d => d.Batch).WithMany(p => p.Batchingitems)
                .HasForeignKey(d => d.Batchid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("batchid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Batchingitems)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("billingfields_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Billingfields)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");
        });
        ...
        modelBuilder.Entity<Carrier>(entity =>
        {
            ...
            entity.HasOne(d => d.Intgrationtype).WithMany(p => p.Carriers)
        ...
        {
            entity.HasKey(e => e.Shipviaid).HasName("shipmethods_pkey");

            entity.ToTable("carrierservice");

            entity.Property(e => e.Shipviaid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(1006L, null, null, null, null, null)
            ...
            entity.HasOne(d => d.Carrier).WithMany(p => p.Carrierservices)
                .HasForeignKey(d => d.Carrierid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("carrierid_fk");

            entity.HasOne(d => d.Client).WithMany(p => p.Carrierservices)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Carriertypeid).HasName("carriertype_pkey");
            ...
            entity.HasOne(d => d.Carrier).WithMany(p => p.Carriertypes)
                .HasForeignKey(d => d.Carrierid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("carrierid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.Carriertypes)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("cart_info_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("carttotes_pkey");
            ...
            entity.HasOne(d => d.Cart).WithMany(p => p.Carttotes)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("clientcartonsizes_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Clientcartonsizes)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.Clientcartonsizes)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("clientshipmethod_pkey");
            ...
            entity.HasOne(d => d.Carrier).WithMany(p => p.Clientshipmethods)
                .HasForeignKey(d => d.Carrierid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("carrierid_fk");

            entity.HasOne(d => d.Client).WithMany(p => p.Clientshipmethods)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.ClientshipmethodEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Integrationchannel).WithMany(p => p.Clientshipmethods)
                .HasForeignKey(d => d.Integrationchannelid)
                .HasConstraintName("fk_clientshipmethod_integrationchannel");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.ClientshipmethodModifiedusers)
        ...
        {
            entity.HasKey(e => e.Csid).HasName("StaffOrderLog_pkey");
        ...
        {
            entity.HasKey(e => e.Csid).HasName("ClientStaffPOLog_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("clienttags_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Clienttags)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Cyclecountid).HasName("cyclecount_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Cyclecounts)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.CyclecountEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.CyclecountModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .HasConstraintName("modifieduserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("cyclecounthistory_pkey");
            ...
            entity.HasOne(d => d.Cyclecount).WithMany(p => p.Cyclecounthistories)
                .HasForeignKey(d => d.Cyclecountid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("cyclecountid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.Cyclecounthistories)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Cyclecounthistories)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("cyclecounttracking_pkey");
            ...
            entity.HasOne(d => d.Cyclecount).WithMany(p => p.Cyclecounttrackings)
                .HasForeignKey(d => d.Cyclecountid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("cyclecountid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.CyclecounttrackingEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.CyclecounttrackingModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .HasConstraintName("modifieduserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Damageid).HasName("pk_damagereason");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("defaultmessages_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("deliverytrucktype_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("errorlog_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("fileupload_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("gridfilters_pkey");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Gridfilters)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("holidaylist_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("integrationcarriermapping_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Integrationcarriermappings)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Integration).WithMany(p => p.Integrationcarriermappings)
                .HasForeignKey(d => d.Integrationid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("integrationid_fk");

            entity.HasOne(d => d.Shipvia).WithMany(p => p.Integrationcarriermappings)
                .HasForeignKey(d => d.Shipviaid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("shipviaid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("channelintegration_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Integrationchannels)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.IntegrationchannelEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Integrationtype).WithMany(p => p.Integrationchannels)
                .HasForeignKey(d => d.Integrationtypeid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("integrationtypeid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.IntegrationchannelModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("integrationdetails_pkey");
            ...
            entity.HasOne(d => d.Channel).WithMany(p => p.Integrationdetails)
                .HasForeignKey(d => d.Channelid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("channelid_fk");

            entity.HasOne(d => d.Integrationproperty).WithMany(p => p.Integrationdetails)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("channelintegration_customfields_pkey");
            ...
            entity.HasOne(d => d.Channel).WithMany(p => p.Integrationmappings)
                .HasForeignKey(d => d.Channelid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("channelid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("properties_pkey");
            ...
            entity.HasOne(d => d.Integrationtype).WithMany(p => p.Integrationproperties)
                .HasForeignKey(d => d.Integrationtypeid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("integrationtypeid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("integrationtypes_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("job_pkey");
            ...
            entity.HasOne(d => d.Cart).WithMany(p => p.Jobs)
                .HasForeignKey(d => d.Cartid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Kid).HasName("kitlog_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("localization_pkey");
        ...
        {
            entity.HasKey(e => e.Manifestid).HasName("pk__manifest__6064f346c2c454c1");
            ...
            entity.Property(e => e.Manifestid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(5001000L, null, null, null, null, null)
            ...
            entity.HasOne(d => d.Carrier).WithMany(p => p.Manifests)
                .HasForeignKey(d => d.Carrierid)
                .HasConstraintName("carrierid_fk");

            entity.HasOne(d => d.Carrierservice).WithMany(p => p.Manifests)
                .HasForeignKey(d => d.Carrierserviceid)
                .HasConstraintName("carrierserviceid_fk");

            entity.HasOne(d => d.Order).WithMany(p => p.Manifests)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("orderid_fk");
        });

        modelBuilder.Entity<Manifestcomment>(entity =>
        {
            entity.HasKey(e => e.Uniqueid).HasName("manifestcomments_pkey");

            entity.ToTable("manifestcomments");
            ...
            entity.HasOne(d => d.Createduser).WithMany(p => p.Manifestcomments)
                .HasForeignKey(d => d.Createduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_userid");

            entity.HasOne(d => d.Manifest).WithMany(p => p.Manifestcomments)
                .HasForeignKey(d => d.Manifestid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_manifestid");
        });

        modelBuilder.Entity<Manifestpackage>(entity =>
        {
            entity.HasKey(e => e.Packageid).HasName("manifestpackage_pkey");
            ...
            entity.Property(e => e.Shipviaid).HasColumnName("shipviaid");
            entity.Property(e => e.Ssccnum)
                .HasMaxLength(25)
                .HasColumnName("ssccnum");
            ...
            entity.HasOne(d => d.Manifest).WithMany(p => p.Manifestpackages)
                .HasForeignKey(d => d.Manifestid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("manifestid_fk");

            entity.HasOne(d => d.Shipvia).WithMany(p => p.Manifestpackages)
                .HasForeignKey(d => d.Shipviaid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("shipviaid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("manifestprintdata_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("manifestskupackagedetails_pkey");
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.Manifestskupackagedetails)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("notes_pkey");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.Batchid).HasColumnName("batchid");
            entity.Property(e => e.Cargoreadydate)
                .HasColumnType("timestamp without time zone")
                .HasColumnName("cargoreadydate");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.OrderEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Mastersku).WithMany(p => p.Orders)
                .HasForeignKey(d => d.Masterskuid)
                .HasConstraintName("masterskuid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.OrderModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Wh).WithMany(p => p.Orders)
        ...
        {
            entity.HasKey(e => e.Id).HasName("ordererrorlog_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Ordererrorlogs)
                .HasForeignKey(d => d.Clientid)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.OrdersourceNavigation).WithMany(p => p.Ordererrorlogs)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("orderimport_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("orderitems_pkey");
            ...
            entity.Property(e => e.Buyerspartnum)
                .HasMaxLength(25)
                .HasColumnName("buyerspartnum");
            ...
            entity.Property(e => e.Upc)
                .HasMaxLength(25)
                .HasColumnName("upc");
            entity.Property(e => e.Variencerefid)
                .HasMaxLength(20)
                .HasColumnName("variencerefid");

            entity.HasOne(d => d.Location).WithMany(p => p.Orderitems)
                .HasForeignKey(d => d.Locationid)
                .HasConstraintName("locationid_fk");

            entity.HasOne(d => d.Manifest).WithMany(p => p.Orderitems)
                .HasForeignKey(d => d.Manifestid)
                .HasConstraintName("manifestid_fk");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("orderitemshistory_pkey");
            ...
            entity.HasOne(d => d.Location).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Locationid)
                .HasConstraintName("locationid_fk");

            entity.HasOne(d => d.Manifest).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Manifestid)
                .HasConstraintName("manifestid_fk");

            entity.HasOne(d => d.Order).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("orderid_fkey");

            entity.HasOne(d => d.Orderitems).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Orderitemsid)
                .HasConstraintName("orderitemsid_fk");

            entity.HasOne(d => d.Package).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Packageid)
                .HasConstraintName("packageid_fk");

            entity.HasOne(d => d.Pickeduser).WithMany(p => p.OrderitemshistoryPickedusers)
                .HasForeignKey(d => d.Pickeduserid)
                .HasConstraintName("pickeduserid_fk");

            entity.HasOne(d => d.Qcuser).WithMany(p => p.OrderitemshistoryQcusers)
                .HasForeignKey(d => d.Qcuserid)
                .HasConstraintName("qcuserid_fk");

            entity.HasOne(d => d.Silunique).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Siluniqueid)
                .HasConstraintName("siluniqueid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Orderitemshistories)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("orderitemstmp_pkey");
            ...
            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.Orderitemstmps)
                .HasForeignKey(d => d.Skuid)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("orderprocessjob_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Orderprocessjobs)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.Orderprocessjobs)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordersearchlist_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordershipaddresslog_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.Ordershipaddresslogs)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Manifest).WithMany(p => p.Ordershipaddresslogs)
                .HasForeignKey(d => d.Manifestid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("manifestid_fk");

            entity.HasOne(d => d.Order).WithMany(p => p.Ordershipaddresslogs)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("orderid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordersjob_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.OrdersjobEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.OrdersjobModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .HasConstraintName("modifieduserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordersjobitems_pkey");

            entity.ToTable("ordersjobitems");

            entity.Property(e => e.Uniqueid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(1010L, null, null, null, null, null)
                .HasColumnName("uniqueid");
            entity.Property(e => e.Cartid).HasColumnName("cartid");
            ...
            entity.HasOne(d => d.Cart).WithMany(p => p.Ordersjobitems)
                .HasForeignKey(d => d.Cartid)
                .HasConstraintName("cartid_fk");

            entity.HasOne(d => d.Job).WithMany(p => p.Ordersjobitems)
                .HasForeignKey(d => d.Jobid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("jobid_fk");

            entity.HasOne(d => d.Manifest).WithMany(p => p.Ordersjobitems)
                .HasForeignKey(d => d.Manifestid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("manifestid_fk");

            entity.HasOne(d => d.Order).WithMany(p => p.Ordersjobitems)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("orderid_fk");

            entity.HasOne(d => d.User).WithMany(p => p.Ordersjobitems)
                .HasForeignKey(d => d.Userid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordersku_serial_pkey");
            ...
            entity.HasOne(d => d.Rodetailed).WithMany(p => p.OrderskuSerials)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("ordersshipment_pkey");
            ...
            entity.Property(e => e.Orderid).HasColumnName("orderid");
            entity.Property(e => e.Othercarrierservice)
                .HasColumnType("character varying")
                .HasColumnName("othercarrierservice");
            entity.Property(e => e.Packingslipurl)
                .HasMaxLength(250)
                .HasColumnName("packingslipurl ");
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.Ordersshipments)
                .HasForeignKey(d => d.Orderid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("orderid_fkey");

            entity.HasOne(d => d.Reqshipvia).WithMany(p => p.Ordersshipments)
        ...
        {
            entity.HasKey(e => e.Id).HasName("passwordresets_pkey");

            entity.ToTable("passwordresets");

            entity.HasIndex(e => e.Resetlink, "passwordresets_resetlink_key").IsUnique();
            ...
            entity.Property(e => e.FkWhuser).HasColumnName("fk_whuser");
            ...
            entity.Property(e => e.Resetlink)
                ...
                .HasColumnName("resetlink");

            entity.HasOne(d => d.FkWhuserNavigation).WithMany(p => p.Passwordresets)
                .HasForeignKey(d => d.FkWhuser)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("whuserid_fk");
        });

        modelBuilder.Entity<Poissue>(entity =>
        {
            entity.HasKey(e => e.Poissueid).HasName("pk_poissue");
        ...
        {
            entity.HasKey(e => e.Id).HasName("poschedule_pkey");
        ...
        {
            entity.HasKey(e => e.Integrationpropertyid).HasName("integrationproperties_pkey");
            ...
            entity.HasOne(d => d.Integrationtype).WithMany(p => p.Properties)
                .HasForeignKey(d => d.Integrationtypeid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Receivingcontainertype>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("receivingcontainertype");
        ...
        modelBuilder.Entity<Return>(entity =>
        {
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Returns)
                .HasForeignKey(d => d.Clientid)
        ...
        {
            entity.HasKey(e => e.Returnitemid).HasName("returnitems_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("robilling_pkey");
            ...
            entity.HasOne(d => d.Ccunique).WithMany(p => p.Robillings)
                .HasForeignKey(d => d.Ccuniqueid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ccuniqueid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.RobillingEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.RobillingModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Pounique).WithMany(p => p.Robillings)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("rochargecodes_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("tmpreceiving_po_pkey");
            ...
            entity.Property(e => e.Palletseries).HasColumnName("palletseries");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Roreceivings)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Completeduser).WithMany(p => p.RoreceivingCompletedusers)
                .HasForeignKey(d => d.Completeduserid)
                .HasConstraintName("completeduserid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.RoreceivingEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("tmpreceiving_pkey");
            ...
            entity.HasOne(d => d.Pou).WithMany(p => p.Roreceivingdetails)
                .HasForeignKey(d => d.Pouid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("po_rec_details_FKey");

            entity.HasOne(d => d.Sku).WithMany(p => p.Roreceivingdetails)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ro_skuid_fk");
        });

        modelBuilder.Entity<Roreceivinghistory>(entity =>
        {
            entity.HasKey(e => e.Uniqueid).HasName("rolotcodes_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.RoreceivinghistoryEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Location).WithMany(p => p.RoreceivinghistoryLocations)
                .HasForeignKey(d => d.Locationid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("locationid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.RoreceivinghistoryModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Pallet).WithMany(p => p.RoreceivinghistoryPallets)
                .HasForeignKey(d => d.Palletid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("palletid_fk");

            entity.HasOne(d => d.Rodetails).WithMany(p => p.Roreceivinghistories)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("rotracking_pkey");
            ...
            entity.HasOne(d => d.Pounique).WithMany(p => p.Rotrackings)
                .HasForeignKey(d => d.Pouniqueid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("pouniqueid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Saleschannelid).HasName("saleschannel_pkey");

            entity.ToTable("saleschannel");

            entity.Property(e => e.Saleschannelid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(1009L, null, null, null, null, null)
        ...
        modelBuilder.Entity<Saleschannelmapping>(entity =>
        {
            entity.HasKey(e => e.Uniqueid).HasName("saleschannelmapping_pkey");

            entity.ToTable("saleschannelmapping");
            ...
            entity.Property(e => e.Saleschannelid).HasColumnName("saleschannelid");
            entity.Property(e => e.Shippingauto).HasColumnName("shippingauto");
            entity.Property(e => e._3rdpartyaccno)
                .HasColumnType("character varying")
                .HasColumnName("3rdpartyaccno");

            entity.HasOne(d => d.Client).WithMany(p => p.Saleschannelmappings)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.Saleschannelmappings)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Saleschannel).WithMany(p => p.Saleschannelmappings)
                .HasForeignKey(d => d.Saleschannelid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("saleschannelid_fk");
        });

        modelBuilder.Entity<Sku>(entity =>
        {
            entity.HasKey(e => e.Skuid).HasName("pk__sku__9aea1bac3674333f");

            entity.ToTable("sku");

            entity.Property(e => e.Skuid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(3000L, null, null, null, null, null)
                .HasColumnName("skuid");
            ...
            entity.Property(e => e.Isfastmoving).HasColumnName("isfastmoving");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Skus)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkuEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkuModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Origin).WithMany(p => p.Skus)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skuchannel_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkuautofillEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkuautofillModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Saleschannel).WithMany(p => p.Skuautofills)
                .HasForeignKey(d => d.Saleschannelid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuchannel_saleschannelid_fkey");

            entity.HasOne(d => d.Sku).WithMany(p => p.Skuautofills)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skubarcode_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkubarcodeEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkubarcodeModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Skubarcodes)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skuinventorylocationkey_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkuinventorylocationEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Location).WithMany(p => p.SkuinventorylocationLocations)
                .HasForeignKey(d => d.Locationid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("locationid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkuinventorylocationModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Pallet).WithMany(p => p.SkuinventorylocationPallets)
                .HasForeignKey(d => d.Palletid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("palletid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Skuinventorylocations)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skuinventorylocation_pkey");
            ...
            entity.HasOne(d => d.Location).WithMany(p => p.Skuinventorylocationlogs)
                .HasForeignKey(d => d.Locationid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("locationid_fk");

            entity.HasOne(d => d.Reason).WithMany(p => p.Skuinventorylocationlogs)
                .HasForeignKey(d => d.Reasonid)
                .HasConstraintName("reasonid_fk");

            entity.HasOne(d => d.Silunique).WithMany(p => p.Skuinventorylocationlogs)
                .HasForeignKey(d => d.Siluniqueid)
                .HasConstraintName("siluniqueid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Skuinventorylocationlogs)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skukitmapping_pkey");
            ...
            entity.HasOne(d => d.Componentsku).WithMany(p => p.SkukitmappingComponentskus)
                .HasForeignKey(d => d.Componentskuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("componentskuid_fk");

            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkukitmappingEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Kitsku).WithMany(p => p.SkukitmappingKitskus)
                .HasForeignKey(d => d.Kitskuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("kitskuid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkukitmappingModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("pk_skulotcode");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skupackage_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.SkupackageEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.SkupackageModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Shippingbox).WithMany(p => p.Skupackages)
                .HasForeignKey(d => d.Shippingboxid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("shippingboxid_fk");

            entity.HasOne(d => d.Sku).WithMany(p => p.Skupackages)
                .HasForeignKey(d => d.Skuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("skuid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("skushippingbox_pkey");
        ...
        modelBuilder.Entity<ViewOrderShipmentreport>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("view_order_shipmentreport");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("warehouse_pkey");

            entity.ToTable("warehouse");

            entity.Property(e => e.Uniqueid)
                .UseIdentityAlwaysColumn()
                .HasIdentityOptions(null, 1000L, null, null, null, null)
                .HasColumnName("uniqueid");
            entity.Property(e => e.Address)
                .HasColumnType("character varying")
                .HasColumnName("address");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.Warehouses)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whclient_pkey");
            ...
            entity.Property(e => e.Dimsweighnotification).HasColumnName("dimsweighnotification");
            entity.Property(e => e.Dimsweightbccemail)
                .HasMaxLength(300)
                .HasColumnName("dimsweightbccemail");
            entity.Property(e => e.Dimsweighttoemail)
                .HasMaxLength(300)
                .HasColumnName("dimsweighttoemail");
            entity.Property(e => e.Entrydate)
                .HasDefaultValueSql("now()")
                .HasColumnType("timestamp without time zone")
                .HasColumnName("entrydate");
            ...
            entity.Property(e => e.Printlotcodeonpalletlabel).HasColumnName("printlotcodeonpalletlabel");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.WhclientEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entryuserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.WhclientModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid");

            entity.HasOne(d => d.Wh).WithMany(p => p.Whclients)
                .HasForeignKey(d => d.Whid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whlocations_pkey");
            ...
            entity.HasOne(d => d.Entryuser).WithMany(p => p.WhlocationEntryusers)
                .HasForeignKey(d => d.Entryuserid)
                .HasConstraintName("entryuserid");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.WhlocationModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid");

            entity.HasOne(d => d.Wh).WithMany(p => p.Whlocations)
                .HasForeignKey(d => d.Whid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("whid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whmodules_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whusers_pkey");
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whuseraccess_pkey");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.Whuserclients)
                .HasForeignKey(d => d.Clientid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("clientid_fk");

            entity.HasOne(d => d.Createduser).WithMany(p => p.WhuserclientCreatedusers)
                .HasForeignKey(d => d.Createduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("createduserid_fk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.WhuserclientModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.User).WithMany(p => p.WhuserclientUsers)
                .HasForeignKey(d => d.Userid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whusersmodules_pkey");
            ...
            entity.HasOne(d => d.Createduser).WithMany(p => p.WhusermoduleCreatedusers)
                .HasForeignKey(d => d.Createduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("createuseridfk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.WhusermoduleModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.Module).WithMany(p => p.Whusermodules)
                .HasForeignKey(d => d.Moduleid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("moduleid_fk");

            entity.HasOne(d => d.User).WithMany(p => p.WhusermoduleUsers)
                .HasForeignKey(d => d.Userid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whuserrefreshtokens_pkey");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Whuserrefreshtokens)
                .HasForeignKey(d => d.Userid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userid_fk");
        });
        ...
        {
            entity.HasKey(e => e.Uniqueid).HasName("whuserwarehouses_pkey");
            ...
            entity.HasOne(d => d.Createduser).WithMany(p => p.WhuserwarehouseCreatedusers)
                .HasForeignKey(d => d.Createduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("createuseridfk");

            entity.HasOne(d => d.Modifieduser).WithMany(p => p.WhuserwarehouseModifiedusers)
                .HasForeignKey(d => d.Modifieduserid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("modifieduserid_fk");

            entity.HasOne(d => d.User).WithMany(p => p.WhuserwarehouseUsers)
                .HasForeignKey(d => d.Userid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userid_fk");

            entity.HasOne(d => d.Wh).WithMany(p => p.Whuserwarehouses)
                .HasForeignKey(d => d.Whid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("whid_fk");
        });
        ...
        modelBuilder.HasSequence("defaultmessages_uniqueid_seq");
        modelBuilder.HasSequence("errorlog_uniqueid_seq");
        modelBuilder.HasSequence("manifestcomments_uniqueid_seq");
        ...
        modelBuilder.HasSequence("orders_orderid_seq")
            .HasMin(1000L)
            .HasMax(2147483647L);
        modelBuilder.HasSequence("saleschannelmapping_uniqueid_seq");
