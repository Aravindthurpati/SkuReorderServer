...
namespace SkuReorderService.Services
{
    public class MailService : IMailService
    {
        ...
        public MailService(MailSettingss settings)
        {
        ...
        //public async Task<bool> SendAsync_bkp(MailData mailData, CancellationToken ct = default)
        //{
        //    try
        //    {
        //        // Initialize a new instance of the MimeKit.MimeMessage class
        ...
        //        {
        //            From = new EmailAddress(_settings.From, _settings.DisplayName),
        ...
        //                if (l == 0)
        //                {
        //                    msg.AddTo(new EmailAddress(mailAddress.Trim()));
        //                }
        //                else
        //                {
        //                    msg.AddCc(new EmailAddress(mailAddress.Trim()));
        //                }
        //                l++;
        //            }
        //        }
        //        //msg.AddTo(new EmailAddress(mailData.To));

        //        if (mailData.Bcc != null)
        //        {
        //            foreach (string mailAddress in mailData.Bcc.Where(x => !string.IsNullOrWhiteSpace(x)))
        //                msg.AddBcc(new EmailAddress(mailAddress.Trim()));
        //        }
        ...
        {
            string pt = "C:/Users/HP/source/repos/SkuReorderService/SkuReorderService/MailTemplate/";
            string templatePath = Path.Combine(pt, $"{emailTemplate}.cshtml");
